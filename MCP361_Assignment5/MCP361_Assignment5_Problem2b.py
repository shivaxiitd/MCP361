...
Lp_prob += 0.6*(p1_Economy + p2_Economy + p3_Economy) >= 0.4*(p1_Standard + p2_Standard + p3_Standard + p1_HeavyD + p2_HeavyD + p3_HeavyD)

status = Lp_prob.solve() # Solver 

print("Additionally specifying that at least 40% of the total number of batteries made must be economy type")
